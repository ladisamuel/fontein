...
const OrderConfirmationPage: React.FC = () => {
  ...
  const getOrder = async () => {
    console.log(params.ref_id || '', params.ref || '');
    

    await getSingleOrderAPI(params.ref_id || '', params.ref || '').then((res)=>{
                ...
                <div className="max-w-7xl mx-auto main_padding py-8">
                  ...
                  <div className="mb-8">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-600">Thank you! Your purchase is confirmed and a receipt has been sent to your email.</p>
                      </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div>
                        ...
                        <p className="text-gray-900">{formatDate(dataState?.created_at)}</p>
                      </div>
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Billing Email</label>
                        <p className="text-gray-900">{dataState?.details?.userDetails?.email}</p>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h3 className="font-semibold text-gray-900">{item.year} {item.make} {item.model}</h3>
                            <p className="text-sm text-gray-600">VIN: 4T1G11AK2MU012345 • Gray • 32,120 mi</p>
                          </div>
                        </div>
                        <div className="text-right">
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h3 className="font-semibold text-gray-900">Extended Warranty Plus (24 mo)</h3>
                            <p className="text-sm text-gray-600">Covers drivetrain, electrical, roadside</p>
                          </div>
                        </div>
                        <div className="text-right">
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div className="flex items-center space-x-2 mb-6">
                      ...
                      <h2 className="text-lg font-semibold text-gray-900">Delivery & Pickup</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Delivery Address</h3>
                        <p className="text-gray-900 mb-1">{dataState?.details?.userDetails?.address}</p>
                        <p className="text-gray-900 mb-3">{dataState?.details?.userDetails?.city} {dataState?.details?.userDetails?.zip}</p>
                        <p className="text-gray-900 mb-3">{dataState?.details?.userDetails?.country}</p>
                        <p className="text-sm text-gray-600"><span className='font-bold'>Special instructions: </span><br /> {dataState?.details?.userDetails?.notes || 'No special note'}</p>
                      </div>

                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">{dataState?.details?.deliveryMethod.toUpperCase()} Option</h3>
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div className="space-y-3">
                      {Object.entries(dataState?.details?.totalBalance||{}).map(([key, value]:any)=>(

                      <div key={key} className="flex justify-between text-gray-700">
                        <span>{value?.name}</span>
                        <span className="font-medium">#{value?.amount?.toLocaleString()}.00</span>
                      </div>
                      ))}
                      ...
                      <div className="border-t border-gray-200 pt-3 mt-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-2xl font-bold text-gray-900">#{dataState?.details?.totalBalance[length].amount.toLocaleString()}.00</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between p-4 bg-amber-50 rounded-lg border border-amber-100">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-medium text-gray-900">Sign Title & Registration Docs</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-medium text-gray-900">Schedule Delivery / Pickup</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-blue-100 text-sm">Jordan Smith • +234-813-757-9041</p>
                        </div>
                      </div>
                      <div className="flex space-x-3">
                        ...
                        <button className="flex items-center space-x-2 px-4 py-2 bg-blue-700 text-white rounded-lg hover:bg-blue-800 font-medium border border-blue-500">
