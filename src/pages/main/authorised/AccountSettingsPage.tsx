    ...
    <div className="min-h-screen mt-[12vh] bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto main_padding py-8">
        ...
        <div className="mb-8">
          <Link
            to="/user/dashboard"
            className=" flex gap-2 items-center mb-5 text-gray-400 border-l border-gray-200 pl-2 cursor-pointer w-fit"
          >
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Your profile details are used for orders and service bookings.
          </p>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600">
                This action is permanent and will remove all your data, orders,
                and services.
              </p>
            </div>
